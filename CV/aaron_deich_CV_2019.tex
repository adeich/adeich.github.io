...
\item[\mydot]
Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now Main career right now 
\item[\mydot]
Masters thesis masters thesis Masters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesisMasters thesis masters thesis

\item[\mydot]
More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff More stuff 
\end{itemize}
\end{multicols}
\vspace*{-1.5em}
\fussy
...
\smalltopic{Data Science and Software Experience}{}
	...
	I ranked causes of unexpectedly high starlight measurement error for an
	 ...
	 I developed DNA sequence string pattern-matching scripts for a cancer research lab. 
	 }
	
	\subtopic[2012-2013]{Markit}{
	etc). I combined millions of records across mismatched SQL telemetry databases and used Jupyter Python notebooks to perform regression and PCA analysis to look for causal relationships. Through } 


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\topic{E \large\hskip -1ex DUCATION}{~}

   \subtopic[2010--Present]{Reed College}{
     Things about my time at Reed. 4 computer science classes. 2 scientific computation classes. }

   \subtopic[2011--Present]{San Jose State University}{
...
\topic{C \large\hskip -1ex omputational and Research Projects}{~}

	\subtopic[2011]{Undergraduate Thesis}{
	Simulated supernovae explosions with Monte Carlo in Mathematica. Found this and this. 
	}  
	
	\subtopic[2016]{Building a small working version of Shazam}{
 ...
 Teaching Assistant \\ 
 \begin{itemize}
 	\item Calculus-based Mechanics (Physics 50)
...
\subtopic[2018]{AAPT Summer Conference}{
	Presented a poster about my thesis work}
